class RoomReportById {
  ...
  RoomReportById.fromJson(Map<String, dynamic> json) {
    result =
...
class Result {
  ...
  // List<Null>? roomMeetingActivities;
  ...
  Result.fromJson(Map<String, dynamic> json) {
    ...
    if (json['rejectedUserRoomActivities'] != null) {
      ...
      json['rejectedUserRoomActivities'].forEach((v) {
        rejectedUserRoomActivities!
            .add(new RejectedUserRoomActivities.fromJson(v));
      });
    }
    ...
    //   roomMeetingActivities = <Null>[];
    //   json['roomMeetingActivities'].forEach((v) {
    //     roomMeetingActivities!.add(new Null.fromJson(v));
    //   });
    // }
    if (json['roomMaterialsActivities'] != null) {
      ...
      json['roomMaterialsActivities'].forEach((v) {
        roomMaterialsActivities!.add(new RoomMaterialsActivities.fromJson(v));
      });
    }
  }
