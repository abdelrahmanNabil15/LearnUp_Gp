...
class _CallPageState extends State<CallPage> {
  ...
  void _addAgoraEventHandlers() {
    _engine.setEventHandler(RtcEngineEventHandler(error: (code) {
      ...
      setState(() {
        final info = 'onJoinChannel: $channel, name: '+ widget.UserName.toString();
        _infoStrings.add(info);
      });
    }, leaveChannel: (stats) {
      setState(() {
      ...
      setState(() {
        final info = 'firstRemoteVideo:  name: '+ widget.UserName.toString()+width.toString()+"x"+ height.toString();
        _infoStrings.add(info);
      });
    }));
  }
